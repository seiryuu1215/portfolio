...
const WORKS: Work[] = [
  {
    ...
    scale: [
      ...
      { value: '122,213', label: '行（TS）' },
      { value: '3077', label: 'テスト' },
      { value: '53', label: 'マイグレーション' },
      { value: '10', label: 'リリース' },
      { value: '37', label: '意思決定記録' },
      { value: '2', label: 'open issue' },
    ],
    images: [
      {
        src: '/images/devdex/01-dashboard.png',
        caption: 'ダッシュボード',
        fit: 'cover',
      },
      {
        src: '/images/devdex/02-terms.png',
        caption: '用語一覧',
        fit: 'cover',
      },
      {
        src: '/images/devdex/03-diagnosis.png',
        caption: 'エンジニアタイプ診断',
        fit: 'cover',
      },
      {
        src: '/images/devdex/04-extract.png',
        caption: '用語抽出',
        fit: 'cover',
      },
      {
        src: '/images/devdex/05-pricing.png',
        caption: '料金プラン',
        fit: 'cover',
      },
      {
        src: '/images/devdex/06-diagnosis-result.png',
  ...
  },
  {
    ...
    motivation:
      '飲み会でスマホ1台あれば盛り上がれるゲームプラットフォームが欲しかった。既存アプリは広告だらけで体験が悪いため、PWA対応・広告なし・オフライン動作可能なWebアプリとして開発。',
    differentiation: [
      '既存の飲みゲーアプリは広告だらけ → 広告なし・PWAでネイティブ級の体験',
      '1ゲーム1アプリが主流 → 7種のゲームを1プラットフォームに集約',
      'サウンドにMP3ファイルを使用 → Web Audio APIでプログラマティックにサウンド生成、ゼロアセット',
    ],
    techStack: [
      'Next.js 16',
      'TypeScript',
    ...
    highlights: [
      'Web Audio API でサイコロ音・BGM・効果音をプログラマティックに生成 — 音声ファイルゼロでリッチなサウンド体験',
      'SVGアニメーションによるルーレット演出 — CSSキーフレームで滑らかな回転を実現',
      '肖像権対応の画像ロック機能 — パスワード認証で一括アンロック、OFF時は絵文字+グラデーションのフォールバック表示',
      '共通コンポーネント設計 — 罰ゲーム選択UI・サウンドシステム・ストレージをゲーム間で再利用',
      'モバイルファースト設計 — タッチ操作に最適化、PWAでホーム画面追加可能',
    ],
    features: [
      '5抜き — 8個のサイコロを振り合計5の組み合わせを除去、最高残り合計のプレイヤーが罰ゲーム',
      'ルーレット — SVGルーレット + CSSアニメーション回転で罰ゲーム決定',
      '指さしゲーム — 3段階レベル（ソフト/ちょいエロ/ハード）各20問',
      'NeverHaveIEver — 3段階レベル各25問、飲んだカウント機能付き',
      '王様ゲーム — 人数設定→番号割当→命令3択、各レベル20命令',
      '二択チキンレース — きわどい二択を各レベル20問',
      '暴露ルーレット — 6ジャンル各15問、SVGルーレットで選出',
    ],
    scale: [
      { value: '7', label: 'ゲーム数' },
      { value: '49', label: 'テスト' },
      { value: '3,457+', label: '追加行数' },
    ],
    status: 'released',
  },
  {
