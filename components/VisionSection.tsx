...
const GROWTH: GrowthItem[] = [
  ...
  },
  {
    ...
    label: 'AI / LLM活用',
    current: 'SubAgents 5体制 + Hooks自動化 + クロスリポ同期を3プロジェクトで運用中',
    next: 'AIをプロダクトに組み込む経験・プロンプトエンジニアリングの深化',
  },
  {
    icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
    label: '設計 / アーキテクチャ',
    current: '20+本の設計書 + ADR 7本をAIと整備済み。設計書自動更新パイプラインも構築',
    next: '大規模システムのアーキテクチャ設計を実務で経験',
  },
  {
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
    label: 'チーム開発への貢献',
    current: '電子新聞PJ（2年9ヶ月）+ 自動車メーカー案件で上流〜運用を一人で担当',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-5 mb-10">
          {GROWTH.map((g) => (
            <div
              key={g.label}
              className="p-5 rounded-xl bg-card border border-border hover:border-accent/30 shadow-card hover:shadow-card-hover hover:-translate-y-0.5 transition-all duration-300 group"
            >
