...
const PRACTICES: Practice[] = [
  ...
  },
  {
    title: 'テスト自動化',
    description:
      '個人開発でもテストを書き、リファクタリングの安全性を確保。Vitest 632テスト + Storybook 190+ストーリー（全40ページ対応）+ Playwright E2E 23シナリオでロジックとUIの両面をカバー。',
    badge: '632テスト + 190+ストーリー',
  ...
  },
  {
    title: 'セキュリティレビュー',
    description:
      '自主セキュリティレビューで CRITICAL 2件・HIGH 5件・MEDIUM 4件を修正。Firestoreフィールド制限・レートリミット・SSRF対策・CSV Injection対策を実装。',
    badge: '11件修正',
