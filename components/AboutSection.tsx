          ...
          <div className="space-y-4">
            ...
            <div className="text-muted leading-relaxed">
              <p>
                ...
                スクラム開発で設計・実装・コードレビュー・Dependabot管理を経験。
                SES勤務を通じて「現場を選べない」ことに危機感を感じフリーランスとして独立。
                独立後は大手自動車メーカー案件でSEとして要件定義から全工程に参画する傍ら、
                AI駆動開発（Claude Code）で個人プロダクトを構築し、技術の幅を広げています。
              </p>
            </div>
