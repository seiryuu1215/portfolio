...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'はい。直近の案件（大手自動車メーカー）では要件定義〜テスト・保守運用まで全工程を一人で担当し、クライアントとの仕様折衝も直接行いました。個人開発でも要件定義書・基本設計書・詳細設計書・セキュリティレビューなど12本の設計ドキュメントをAIと協働で整備しており、上流から下流まで一気通貫で対応できます。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '90,000行・632テストの個人SaaS開発を通じて、認証・決済・セキュリティ・CI/CD・テスト設計・DB設計を全て自分で判断・実装してきました。「動くだけ」ではなく運用を見据えた設計ができる点、要件の背景を理解して代替案を提案できる点が実務にも直結しています。',
  },
];
